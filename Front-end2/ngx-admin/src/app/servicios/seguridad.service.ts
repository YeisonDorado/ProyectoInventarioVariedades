...
public get usuarioSesionActiva(): Usuarios {
  ...
  */
  ...
  return this.http.post<Usuarios>(`${environment.url_gateway}/login`,
  infoUsuario);
  }
  /**
  ...
  */
  ...
  // SERVICIOS PARA MODIFICAR USUARIOS -----------------------------------------------------------------------------
...
asignarRol(id: string, rol_id: string): Observable<Usuarios> {
  
  return this.http.put<Usuarios>(`${environment.url_gateway}/usuarios/${id}/rol/${rol_id}`, {})
